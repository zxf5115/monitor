...
class Model(Migration):
  ...
  def up(self):
    ...
    try:
      ...
      self.integer('company_id', 11, 0, '公司编号')

      self.varchar('portal', 50, '', '门户网站')
      self.varchar('contact', 20, '', '联系人')
      self.varchar('stock_code', 20, '', '股票代码')
  ...
  def add(self):
    ...
    try:
      ...
      # sql = "insert into company_extension (version, create_time) values (%s,%s)"
